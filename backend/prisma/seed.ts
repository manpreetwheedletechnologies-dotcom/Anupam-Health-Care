...
const SERVICES = [
  ...
  { title: "ECG at Home", slug: "ecg-at-home", desc: "Professional ECG test at your home with instant report delivery.", longDesc: "Skip the hospital visits for heart monitoring. Our trained technicians bring a portable ECG machine to your doorstep, perform the test in minutes under comfortable settings, and deliver accurate reports for doctor evaluation.", icon: "Heart", color: "navy", bg: "sky", features: ["Portable ECG machine", "Trained technicians", "Instant report delivery"], benefits: ["Comfort of home", "Safe and convenient", "Saves time and travel stress"], process: ["Book your ECG slot online or via call", "Technician arrives with the portable ECG setup", "Get your test done and receive the report quickly"], image: "/images/services/ecg-at-home.jpg", order: 11 },
  { title: "X-Ray at Home", slug: "x-ray-at-home", desc: "Hospital-grade digital X-Ray services in the comfort of your home.", longDesc: "Getting a patient with joint pain, fractures, or limited mobility to a diagnostic center is painful. Our advanced portable X-ray service brings safe, low-radiation imaging directly to your bedroom with high-quality digital results.", icon: "Activity", color: "green", bg: "greenLight", features: ["Portable digital X-ray", "Certified radiographer", "Fast digital image processing"], benefits: ["No painful transport for patients", "Immediate digital report sharing", "Safe, low-radiation equipment"], process: ["Schedule your X-ray visit with prescription details", "Certified technician performs the scan at your home", "Digital report is shared with your doctor online"], image: "/images/services/x-ray-at-home.jpg", order: 12 },
  { title: "ICU Setup at Home", slug: "icu-setup-at-home", desc: "Setup a hospital-like ICU in your bedroom with advanced equipment & 24/7 nursing.", longDesc: "Bring advanced critical care home. We configure complete ICU setups with ventilators, monitors, oxygen therapy, and critical care medical equipment, staffed by specialized critical care nurses for round-the-clock patient management.", icon: "BedDouble", color: "navy", bg: "sky", features: ["Critical care equipment", "24/7 specialized nursing", "Daily doctor review"], benefits: ["Cost-effective alternative to hospital ICU", "Near loved ones in a comfortable space", "Strict infection control standards"], process: ["Consultation with critical care team", "Equipment delivery and custom setup", "24/7 nurse deployment and monitoring begins"], image: "/images/services/icu-setup-at-home.jpg", order: 13 },
];
